...
void Main::Loop()
{
	...
	while (true)
	{
		...
		{
			DrawScreenText("Efectos Limpiados!", { .86f, .86f }, .8f, { 255, 100, 100 }, true);
		...
		{
			DrawScreenText("Votacion De Twitch Activada!", { .86f, .7f }, .8f, { 255, 100, 100 }, true);
